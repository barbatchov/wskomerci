...
class ConfirmTxn_ADMap implements TypemapInterface {
    const DATA = 'Data';
    ...
    const COD__BANCO = 'Cod_Banco';
    const ORIGEM__BIN = 'Origem_Bin';
    ...
    public function getProperty($name = '') {
        $array = array(
            ...
            'Cod_Banco' => array('name' => 'Cod_Banco', 'type' => 'string', 'size' => null),
            'Origem_Bin' => array('name' => 'Origem_Bin', 'type' => 'string', 'size' => null),
